...
namespace BarneyGo.Controllers
{
    public class DaysController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,SyllabusId,Date,Location,Topics,Labs,NextClass")] Day day)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,SyllabusId,Date,Location,Topics,Labs,NextClass")] Day day)
        {
            if (ModelState.IsValid)
            {
